    ...
    >
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="rounded-3xl border border-emerald-100 bg-white/80 p-6 shadow-xl shadow-emerald-200/30 backdrop-blur-sm">
          ...
          <p className="mt-2 text-sm text-slate-600">Sell in seconds with a clean cart flow built for busy counters.</p>
        </div>
        <div className="rounded-3xl border border-emerald-100 bg-white/80 p-6 shadow-xl shadow-emerald-200/30 backdrop-blur-sm">
          <div className="inline-flex rounded-2xl bg-emerald-50 p-3 text-emerald-700">
            <Package className="h-5 w-5" />
          </div>
          <h3 className="mt-4 text-lg font-bold text-slate-900">Inventory Tracking</h3>
          <p className="mt-2 text-sm text-slate-600">Add products, update stock, and spot low inventory quickly.</p>
        </div>
        <div className="rounded-3xl border border-emerald-100 bg-white/80 p-6 shadow-xl shadow-emerald-200/30 backdrop-blur-sm">
          <div className="inline-flex rounded-2xl bg-emerald-50 p-3 text-emerald-700">
            <ShieldCheck className="h-5 w-5" />
          </div>
          <h3 className="mt-4 text-lg font-bold text-slate-900">Reliable & Secure</h3>
          <p className="mt-2 text-sm text-slate-600">Your records stay consistent across sessions and devices.</p>
        </div>
      </div>
      ...
      <div className="mt-6 grid gap-6 lg:grid-cols-2">
        <div className="rounded-3xl border border-emerald-100 bg-white/80 p-6 shadow-xl shadow-emerald-200/30 backdrop-blur-sm md:p-8">
          <h3 className="text-xl font-bold text-slate-900">Built for small businesses</h3>
        ...
        <div className="rounded-3xl border border-emerald-100 bg-white/80 p-6 shadow-xl shadow-emerald-200/30 backdrop-blur-sm md:p-8">
          ...
          <h3 className="mt-4 text-xl font-bold text-slate-900">Start with your best sellers</h3>
          <p className="mt-2 text-slate-600">
            Add the products you sell most often first. You&apos;ll get faster checkouts and cleaner tracking from day one.
          </p>
          <Link href="/login?tab=signup" className="mt-6 inline-block rounded-xl bg-emerald-600 px-5 py-3 text-sm font-semibold text-white hover:bg-emerald-500">
            Create an account
          </Link>
        </div>
      </div>
